        ...
        namespace shaders {
            namespace blur {
                ...
                void shader::draw() {
                    ...
                    rect calc_uv = region / display_size;
                ...
                void shader::begin_draw() {
                    ...
                    set_constants(display_size / amount);
                }
                ...
                void shader::set_constants(vec2 size) {
                    vec2 clamp_x = vec2(region.min.x + 1.f, region.max.x - 1.f) / display_size.x;
                    vec2 clamp_y = vec2(region.min.y + 1.f, region.max.y - 1.f) / display_size.y;
                ...
                void create_shader_control() {
                    if(!shader_x) shader_x.init(sources::blur_x, sizeof(sources::blur_x), sizeof(constant));
                    if(!shader_y) shader_y.init(sources::blur_y, sizeof(sources::blur_y), sizeof(constant));
                }
